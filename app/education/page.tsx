...
export default function TradingEducationHub() {
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 py-8">
          ...
          {PILLARS.map((pillar, index) => {
            ...
            return (
              <Link
                key={pillar.id}
                href={pillar.slug}
                className="group bg-white rounded-2xl border border-gray-200 p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
              >
                ...
                <div className="flex items-center justify-between">
                  <span className="text-xs text-gray-500">{articleCount} guides</span>
          ...
          <div key={pillar.id} className="mb-12">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-gray-600 mt-1">{pillar.intro}</p>
              </div>
              <Link 
                href={pillar.slug}
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              {ARTICLES.filter(a => a.pillar === pillar.id).length > 2 && (
                <Link
                  href={pillar.slug}
                  className="flex items-center justify-center bg-gradient-to-r from-gray-50 to-gray-100 hover:from-blue-50 hover:to-blue-100 rounded-2xl border-2 border-dashed border-gray-300 hover:border-blue-300 p-6 transition-all duration-200 group"
                >
      ...
      <section className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-3xl p-8 mb-16">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">New to Trading?</h2>
      ...
      <section className="text-center bg-gray-50 rounded-2xl p-8">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="text-3xl font-bold text-purple-600 mb-2">{PILLARS.length}</div>
