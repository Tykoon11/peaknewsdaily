    ...
    <main className="container py-8 max-w-4xl mx-auto">
      ...
      <article className="prose prose-lg max-w-none">
        ...
        <div class="bg-indigo-100 p-6 rounded-lg my-8">
          <h3 class="text-lg font-semibold text-indigo-800 mb-4">Market Research Process</h3>
          <div class="grid md:grid-cols-3 gap-4">
            <div>
              <h4 class="font-semibold text-indigo-800 mb-2">Online Valuations</h4>
            ...
            <div>
              <h4 class="font-semibold text-indigo-800 mb-2">Local Comps</h4>
              <ul class="text-indigo-700 text-sm space-y-1">
            ...
            <div>
              <h4 class="font-semibold text-indigo-800 mb-2">Instant Offers</h4>
              <ul class="text-indigo-700 text-sm space-y-1">
        ...
        <div class="bg-green-100 p-6 rounded-lg my-8">
          <h3 class="text-lg font-semibold text-green-800 mb-4">Pricing Psychology</h3>
        ...
        <div class="bg-red-50 border border-red-200 rounded-lg p-6 my-8">
          <h3 class="text-lg font-semibold text-red-800 mb-4">Buyer Screening Checklist</h3>
        ...
        <div class="space-y-6 my-8">
          <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
            <h3 class="text-lg font-semibold text-blue-800 mb-4">Safe Meeting Protocol</h3>
            <div class="grid md:grid-cols-2 gap-4">
              <div>
                <h4 class="font-semibold text-blue-800 mb-2">Location Safety</h4>
              ...
              <div>
                <h4 class="font-semibold text-blue-800 mb-2">Personal Safety</h4>
                <ul class="text-blue-700 text-sm space-y-1">
          ...
          <div class="bg-orange-50 border border-orange-200 rounded-lg p-6">
            <h3 class="text-lg font-semibold text-orange-800 mb-4">Test Drive Ground Rules</h3>
        ...
        <div class="bg-purple-100 p-6 rounded-lg my-8">
          <h3 class="text-lg font-semibold text-purple-800 mb-4">Safe Payment Methods</h3>
          <div class="grid md:grid-cols-2 gap-6">
            <div class="bg-green-50 p-4 rounded">
              <h4 class="font-semibold text-green-800 mb-2">✓ Safe Payment Options</h4>
            ...
            <div class="bg-red-50 p-4 rounded">
              <h4 class="font-semibold text-red-800 mb-2">✗ Never Accept These</h4>
        ...
        <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-6 my-8">
          <h3 class="text-lg font-semibold text-yellow-800 mb-4">Bank Verification Process</h3>
          <div class="text-yellow-700 space-y-3">
        ...
        <div class="bg-gray-100 p-6 rounded-lg my-8">
          <h3 class="text-lg font-semibold text-gray-800 mb-4">Essential Documents Checklist</h3>
          <div class="grid md:grid-cols-2 gap-6">
            <div>
              <h4 class="font-semibold text-gray-800 mb-2">You Must Provide</h4>
            ...
            <div>
              <h4 class="font-semibold text-gray-800 mb-2">Buyer Should Provide</h4>
              <ul class="text-gray-700 text-sm space-y-1">
        ...
        <div class="bg-indigo-50 border border-indigo-200 rounded-lg p-6 my-8">
          <h3 class="text-lg font-semibold text-indigo-800 mb-4">Lien Payoff Process</h3>
        ...
        <div class="bg-green-50 border border-green-200 rounded-lg p-6 my-8">
          <h3 class="text-lg font-semibold text-green-800 mb-4">Common Buyer Responses & Scripts</h3>
          <div class="space-y-4">
            <div>
              <h4 class="font-semibold text-green-800">"Your price is too high"</h4>
              <p class="text-green-700 text-sm">"I've priced it based on current market value and condition. Here's my research [show comps]. What did you have in mind?"</p>
            </div>
            
            <div>
              <h4 class="font-semibold text-green-800">"I found similar cars for less"</h4>
              <p class="text-green-700 text-sm">"Those might have higher mileage or different conditions. This one has [recent maintenance/low miles/clean history]. I'm firm at [price] for the quality."</p>
            </div>
            
            <div>
              <h4 class="font-semibold text-green-800">"I need to think about it"</h4>
              <p class="text-green-700 text-sm">"I understand. I have other people interested, so I can't hold it. If you're serious, a small deposit would secure it while you decide."</p>
            </div>
            
            <div>
              <h4 class="font-semibold text-green-800">"Will you take [lowball offer]?"</h4>
              <p class="text-green-700 text-sm">"That's quite a bit below my asking price. I could consider [counter-offer], but that's as low as I can go given the condition and market value."</p>
            </div>
          </div>
        </div>
        ...
        <div class="bg-red-100 p-6 rounded-lg my-8">
          <h3 class="text-lg font-semibold text-red-800 mb-4">Red Flag Warning Signs</h3>
          <div class="space-y-4">
            <div class="border-l-4 border-red-400 pl-4">
              <h4 class="font-semibold text-red-800">Overpayment scam</h4>
              <p class="text-red-700 text-sm">"I'll pay extra, please send the difference to my shipper." Always a scam—walk away immediately.</p>
            </div>
            
            <div class="border-l-4 border-red-400 pl-4">
              <h4 class="font-semibold text-red-800">Fake payment methods</h4>
              <p class="text-red-700 text-sm">Counterfeit cashier's checks and money orders look real. Always verify at the issuing bank.</p>
            </div>
            
            <div class="border-l-4 border-red-400 pl-4">
              <h4 class="font-semibold text-red-800">Pressure tactics</h4>
              <p class="text-red-700 text-sm">"I'm leaving town tomorrow" or "I have the cash right now." Legitimate buyers don't create artificial urgency.</p>
            </div>
            
            <div class="border-l-4 border-red-400 pl-4">
              <h4 class="font-semibold text-red-800">Title fraud</h4>
              <p class="text-red-700 text-sm">"Can you sign the title and I'll fill in the details later?" Never sign a blank title—complete all fields together.</p>
            </div>
          </div>
        </div>
        ...
        <div class="bg-gray-50 rounded-lg p-8 mt-12">
          ...
          <div class="space-y-6">
            <div>
              <h3 class="text-lg font-semibold text-gray-900 mb-2">Is CarFax worth attaching?</h3>
              <p class="text-gray-700">Yes, if the report is clean. A good CarFax report builds buyer confidence and can justify your asking price. If the report shows issues, address them upfront in your listing.</p>
            </div>
            
            <div>
              <h3 class="text-lg font-semibold text-gray-900 mb-2">How do I accept payment safely?</h3>
              <p class="text-gray-700">Cash verified at a bank, or cashier's check verified at the issuing bank are safest. For amounts over $10,000, meet at the buyer's bank to complete the transaction.</p>
            </div>
            
            <div>
              <h3 class="text-lg font-semibold text-gray-900 mb-2">What if a buyer wants to take the car to a mechanic?</h3>
              <p class="text-gray-700">That's reasonable for expensive cars, but ensure you go together. Get a written agreement that they're liable for any damage, and verify their insurance covers test drives.</p>
            </div>

            <div>
              <h3 class="text-lg font-semibold text-gray-900 mb-2">Can I sell with an active lien?</h3>
              <p class="text-gray-700">Yes, but coordinate with your lender. Meet at the bank, buyer pays lender directly for the payoff amount, and you pay any difference. The lender releases the title to the buyer.</p>
            </div>
          </div>
        </div>
      </article>
      ...
      <nav class="mt-16 pt-8 border-t border-gray-200">
        <div class="grid md:grid-cols-2 gap-8">
          <div>
            ...
            >
              <h3 class="font-semibold text-indigo-900">← Insure New Car for Less</h3>
              <p class="text-sm text-indigo-700 mt-1">Cut insurance costs legally</p>
            </Link>
          </div>
          ...
          <div>
            ...
            >
              <h3 class="font-semibold text-green-900">Bad Car Loan Exit →</h3>
              <p class="text-sm text-green-700 mt-1">Escape high payments safely</p>
            </Link>
          </div>
        </div>
      </nav>
