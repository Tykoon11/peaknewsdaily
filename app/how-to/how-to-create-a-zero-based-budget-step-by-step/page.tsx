      ...
      <nav className="mt-16 pt-8 border-t border-gray-200">
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            ...
            >
              <h3 className="font-semibold text-blue-900">Track Expenses Automatically</h3>
              <p className="text-sm text-blue-700 mt-1">No spreadsheets required</p>
            </Link>
          </div>
          ...
          <div>
            ...
            >
              <h3 className="font-semibold text-green-900">Pay Yourself First</h3>
              <p className="text-sm text-green-700 mt-1">Automate savings that stick</p>
            </Link>
          </div>
        </div>
      </nav>
