        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            ...
            >
              ...
              <p className="text-sm text-blue-700 mt-1">Reconcile like a pro</p>
            </Link>
          </div>
          ...
          <div>
            ...
            >
              <h3 className="font-semibold text-green-900">Credit Unions vs Banks</h3>
              <p className="text-sm text-green-700 mt-1">Pros, cons & when to choose</p>
            </Link>
          </div>
        </div>
      </nav>
