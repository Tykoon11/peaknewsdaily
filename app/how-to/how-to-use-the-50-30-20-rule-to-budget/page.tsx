      ...
      <nav className="mt-16 pt-8 border-t border-gray-200">
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            ...
            >
              <h3 className="font-semibold text-blue-900">Build a Monthly Budget That Works</h3>
              <p className="text-sm text-blue-700 mt-1">Learn the complete 5-step budgeting system</p>
            </Link>
          </div>
          ...
          <div>
            ...
            >
              <h3 className="font-semibold text-green-900">Budget with Irregular Income</h3>
              <p className="text-sm text-green-700 mt-1">Freelancers & gig workers budgeting guide</p>
            </Link>
          </div>
        </div>
      </nav>
