      ...
      <nav className="mt-16 pt-8 border-t border-gray-200">
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            ...
            <Link 
              href="/how-to/how-to-pay-yourself-first-and-automate-savings" 
              className="block p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors"
            >
              <h3 className="font-semibold text-blue-900">Pay Yourself First</h3>
              <p className="text-sm text-blue-700 mt-1">Automate savings that stick</p>
            </Link>
          </div>
          ...
          <div>
            ...
            >
              <h3 className="font-semibold text-green-900">Save Money on Low Income</h3>
              <p className="text-sm text-green-700 mt-1">Practical steps when money's tight</p>
            </Link>
          </div>
        </div>
      </nav>
