      ...
      <nav className="mt-16 pt-8 border-t border-gray-200">
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            ...
            >
              <h3 className="font-semibold text-blue-900">Stop Living Paycheck to Paycheck</h3>
              <p className="text-sm text-blue-700 mt-1">Break the cycle with a 7-step plan</p>
            </Link>
          </div>
          ...
          <div>
            ...
            >
              <h3 className="font-semibold text-green-900">Use Sinking Funds</h3>
              <p className="text-sm text-green-700 mt-1">Pay for big purchases without debt</p>
            </Link>
          </div>
        </div>
      </nav>
