        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            ...
            >
              ...
              <p className="text-sm text-blue-700 mt-1">Practical steps when money's tight</p>
            </Link>
          </div>
          ...
          <div>
            ...
            >
              <h3 className="font-semibold text-green-900">Set SMART Financial Goals</h3>
              <p className="text-sm text-green-700 mt-1">Templates & examples included</p>
            </Link>
          </div>
        </div>
      </nav>
