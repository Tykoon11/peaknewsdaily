      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900">
        ...
        <div className="relative container mx-auto px-3 xs:px-4 py-8 xs:py-10 sm:py-12 md:py-16 lg:py-20">
          <div className="max-w-5xl mx-auto text-center">
            {/* Live Market Status */}
            <div className="inline-flex items-center px-3 xs:px-4 sm:px-6 py-1.5 xs:py-2 sm:py-3 rounded-full bg-green-500/20 border border-green-400/30 text-green-300 text-xs sm:text-sm font-medium mb-4 xs:mb-6 sm:mb-8 backdrop-blur-sm mx-2 xs:mx-0">
              <div className="w-1.5 h-1.5 xs:w-2 xs:h-2 bg-green-400 rounded-full animate-pulse mr-1.5 xs:mr-2 sm:mr-3"></div>
              <span className="hidden sm:inline">LIVE MARKET DATA • GLOBAL COVERAGE • </span>REAL-TIME UPDATES
            </div>
            
            <h1 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black mb-3 xs:mb-4 sm:mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white via-blue-100 to-indigo-200 leading-tight px-2 xs:px-4 sm:px-0">
              Financial Markets
            ...
            <p className="text-sm xs:text-base sm:text-lg md:text-xl lg:text-2xl text-blue-100/80 mb-4 xs:mb-6 sm:mb-8 max-w-3xl mx-auto leading-relaxed px-3 xs:px-4 sm:px-6 lg:px-0">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 xs:gap-4 sm:gap-6 mt-6 xs:mt-8 sm:mt-12 px-2 xs:px-0">
      ...
      <main className="bg-gradient-to-b from-slate-50 to-white dark:bg-gradient-to-b dark:from-gray-900 dark:to-gray-800">
        <div className="container mx-auto px-3 xs:px-4 py-6 xs:py-8 sm:py-12 lg:py-16">
          ...
          <section className="mb-12 sm:mb-16 lg:mb-20">
            <div className="text-center mb-6 xs:mb-8 sm:mb-12 px-2 xs:px-0">
              <h2 className="text-xl xs:text-2xl sm:text-3xl lg:text-4xl font-bold text-slate-800 dark:text-gray-100 mb-2 xs:mb-3 sm:mb-4">Market Categories</h2>
              <p className="text-sm xs:text-base sm:text-lg md:text-xl text-slate-600 dark:text-gray-300 max-w-3xl mx-auto px-2 xs:px-4 sm:px-0">
